...
ActiveRecord::Schema.define(version: 2021_06_05_082445) do
  ...
  create_table "best_nines", force: :cascade do |t|
    ...
    t.index ["user_id", "created_at"], name: "index_best_nines_on_user_id_and_created_at"
    t.index ["user_id"], name: "index_best_nines_on_user_id"
  end
  ...
  add_foreign_key "best_nines", "users"
end
